...
//E2 LEFT
//E1 RIGHT
#define rxPin 11 // Pin 11 as RX, to be connected to TX of the HC-05
#define txPin 10 // Pin 10 as TX, to be connected to RX of HC-05
...
char MqttServer[] = "YOUR IP ADDRESS"; // your ip address
